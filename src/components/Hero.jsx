import { BookOpen, Star, GitFork, Activity, Sparkles, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-8 md:py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-github-green font-semibold text-sm tracking-wide">CELESTIS OPEN SOURCE EVENT</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-github-textMuted mb-4 max-w-2xl leading-relaxed">
            A week-long open-source event designed to provide participants with hands-on experience across multiple technical domains, through a <span className="text-github-blue font-semibold">mythology-inspired progression system</span>.
          </p>
          
          <p className="text-base text-github-textMuted max-w-2xl leading-relaxed mb-8">
            Grow from beginners to skilled contributors and become the <span className="text-github-blue font-semibold">Huanglong Warrior</span> — Master of All Domains.
          </p>
        ...
        <div className="flex flex-wrap gap-6 pt-8 border-t border-github-border">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-2xl font-bold text-github-textPrimary">9k</div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-2xl font-bold text-github-textPrimary">1.2k</div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-2xl font-bold text-github-textPrimary">4</div>
